...
module.exports.getProductAttribute = function*(opts) { // for finding product attribute from index
...
module.exports.addCategoryInElastic = function*(opts) { // for adding product in index
