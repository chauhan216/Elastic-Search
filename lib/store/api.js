...
module.exports.getReviews = function*(opts) {
    ...
    try {
        var reviews = yield reviewDb.reviewCollection.find({
...
module.exports.updateReview = function*(opts) {
    ...
    try {
        var review = yield reviewDb.reviewCollection.findOne({
...
module.exports.deleteReview = function*(opts) {
    ...
    try {
        var reviewDelete = yield reviewDb.reviewCollection.findOne({
            "creator_id": opts.creator_id
        }).exec();
        if (!reviewDelete) {
            throw new Error("creater is invalid");
        }
        yield reviewDb.reviewCollection.remove({
            "creator_id": opts.creator_id
        }).exec();
        return reviewDelete;
    } catch (err) {
...
module.exports.getSubCategories = function*(opts) {
    ...
    try {
        ...
        var brands = yield ElasticAPI.attributeCount(parentCategory,thisattributes,categories);
        var finalResult = {}
        finalResult["subcategories"] = categories;
        finalResult["attributes"] = thisattributes;
        finalResult["countBrand"] = brands;
...
module.exports.updateCategory = function*(opts) {
    ...
    try {
        ...
        if (opts.body["name"]) {
            ...
            yield categoryDb.categoryCollection.update({
...
module.exports.deleteCategory = function*(opts) {
    ...
    try {
        var categoryDelete = yield categoryDb.categoryCollection.findOne({
            "category_code": opts.category_code
        }).exec();
        if (!categoryDelete) {
            throw new Error("category  is invalid");
        }
        yield categoryDb.categoryCollection.remove({
            "category_code": opts.category_code
        }).exec();
...
module.exports.updateProduct = function*(opts) {
    ...
    try {
        var product = yield productDb.productCollection.findOne({
            "product_id": opts.id
        }).exec();
        if (!product) {
...
module.exports.productDelete = function*(opts) {
    ...
    try {
        var productDelete = yield productDb.productCollection.findOne({
            "product_id": opts.id
        }).exec();
        if (!productDelete) {
            throw new Error("product_id  is invalid");
        }
        yield productDb.productCollection.remove({
            "product_id": opts.id
        }).exec();
...
module.exports.getStore = function*(opts) {
    ...
    try {
        var stores = yield storeDb.storeCollection.find({
            "store_id": opts.id
        }).exec();
        if (!stores) {
...
module.exports.updateStore = function*(opts) {
    ...
    try {
        var stores = yield storeDb.storeCollection.findOne({
            "store_id": opts.id
        }).exec();
        if (!stores) {
            throw new Error("store_id  is invalid");
...
module.exports.storeDelete = function*(opts) {
    ...
    try {
        ...
        yield storeDb.storeCollection.remove({
            "store_id": opts.id
        }).exec();
        return stores;
    } catch (err) {
